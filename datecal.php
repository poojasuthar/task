...
?>
<div style="height:100%; width:100%; background-color:yellow;text-align:center; ">
...
<form method="post" >
<table width="500" border="5" cellspacing="10" cellpadding="3" align="center" style="margin-top: 150px;">
<tr>
<th style="color:white;">Select First Date</th>
<td><input type="date" name="date1" placeholder="Select Date1"/></td>
</tr>
<tr>
<th style="color:white;">Select Second Date</th>
<td><input type="date" name="date2" placeholder="Select Date2"/></td>
</tr>
<tr>
<th style="color:white;" colspan="2" scope="row">
<input type="submit" name="findDiff" value="Find Difference" />
</th>
</tr>
<tr>
<th style="color:white;" colspan="2" scope="row">
The Difference of given date is shown below::
</th>
</tr>
